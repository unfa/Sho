...
var walk_target_velocity = Vector2()
...
func _physics_process(delta):
	...
	state_sloped_ground = true if ground.get_collision_normal() != UP else false
	...
	motion = self.move_and_slide(velocity * delta, UP)
